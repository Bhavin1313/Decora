...
class Global {
  ...
  static TextStyle size15b = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 14,
    fontWeight: FontWeight.w600,
    color: Color(0xff000000),
  ...
  static TextStyle size12black = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 12,
    color: Color(0xff000000),
    fontWeight: FontWeight.w600,
  ...
  static TextStyle size13 = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 13,
  ...
  static TextStyle size15Montserrat = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 15,
  ...
  static TextStyle size20white = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 20,
    color: Color(0xffFFFFFF),
    fontWeight: FontWeight.w600,
  ...
  static TextStyle size15white = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 15,
    color: Color(0xffFFFFFF),
    fontWeight: FontWeight.w500,
  ...
  static TextStyle size22white = GoogleFonts.getFont(
    'Montserrat',
    fontSize: 22,
    color: Color(0xffFFFFFF),
    fontWeight: FontWeight.w600,
  ...
  static TextStyle size12jost = GoogleFonts.getFont(
    'Jost',
    fontWeight: FontWeight.w400,
    fontSize: 12,
